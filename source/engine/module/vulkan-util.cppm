...
export bool AreInstanceExtensionsSupported(const vk::raii::Context& context, const concepts::RangeOfCastableTo<std::string_view> auto& wanted)
{
    auto availables = context.enumerateInstanceExtensionProperties();
